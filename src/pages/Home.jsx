        ...
        <>
            <div className='container'>
                <div className='flex flex-col h-screen'>
                    <h2 className='text-left mb-3 mt-28 secondary_heading'>Welcome to the <h1 className='text-[#1c72b8] uppercase secondary_heading'>Compete Programming</h1> Solutions</h2>
