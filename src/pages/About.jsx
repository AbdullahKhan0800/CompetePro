  ...
  return (
    <>
      <div className='container'>
        ...
        <div className=' rounded-xl bg-gradiant relative text-center flex w-full py-40 justify-center items-center flex-col gap-10 z-[-1]'>
        ...
        <h3 className='text-center mt-14 mb-7'>Our Edge</h3>
        <div className='grid grid-cols-2 grid-rows-2 justify-between gap-10 mb-14'>
          <div className='rounded-xl shadow-lg grid gap-5 p-5'>
