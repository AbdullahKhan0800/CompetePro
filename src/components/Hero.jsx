...
function Hero({ explore, setexplore }) {
    ...
    return (
        <div className='w-full absolute z-40 transition-all duration-500 explore' style={explore === false ? { transform: 'translateY(-100%)' } : { transform: 'translateY(0%)' }} onClick={() => setexplore(prev => !prev)}>
            <MainParticles />
